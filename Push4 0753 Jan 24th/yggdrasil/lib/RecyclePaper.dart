...
class _RecyclePaperListScreenState
    extends State<RecyclePaperListScreen> {
...
class _AddRecyclePaperScreenState
    extends State<AddRecyclePaperScreen> {
  ...
  void _sendDataBack(BuildContext context) {
    ...
    var writtenProposal = Recycle(
        'PaperAndPlastic', recycleDescription, recycleQuantity, recycleSubCategory);
