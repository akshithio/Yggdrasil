...
class _RecycleOrganicListScreenState
    extends State<RecycleOrganicListScreen> {
...
class _AddRecycleOrganicScreenState
    extends State<AddRecycleOrganicScreen> {
  ...
  void _sendDataBack(BuildContext context) {
    ...
    var writtenProposal = Recycle(
        'Organic Material', recycleDescription, recycleQuantity, recycleSubCategory);
