...
class RecyclePaperListScreen extends StatefulWidget {
  @override
  _RecyclePaperListScreenState createState() {
    return _RecyclePaperListScreenState();
  }
}

class _RecyclePaperListScreenState extends State<RecyclePaperListScreen> {
  void _awaitReturnValueFromInputScreen(BuildContext context) async {
    final result = await Navigator.pushNamed(context, '/AddRecyclePaper');
    if (result != null) {
    ...
    return Scaffold(
        ...
        body: FutureBuilder(
            future: Firestore.instance
                .collection('recycles')
                .where('category', isEqualTo: 'PaperAndPlastic')
                .getDocuments(),
...
class AddRecyclePaperScreen extends StatefulWidget {
  @override
  _AddRecyclePaperScreenState createState() {
    return _AddRecyclePaperScreenState();
  }
}

class _AddRecyclePaperScreenState extends State<AddRecyclePaperScreen> {
  ...
  void _sendDataBack(BuildContext context) {
    ...
    var writtenProposal = Recycle('PaperAndPlastic', recycleDescription,
        recycleQuantity, recycleSubCategory);
