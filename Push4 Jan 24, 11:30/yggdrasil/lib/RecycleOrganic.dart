...
class RecycleOrganicListScreen extends StatefulWidget {
  @override
  _RecycleOrganicListScreenState createState() {
    return _RecycleOrganicListScreenState();
  }
}

class _RecycleOrganicListScreenState extends State<RecycleOrganicListScreen> {
  void _awaitReturnValueFromInputScreen(BuildContext context) async {
    final result = await Navigator.pushNamed(context, '/AddRecycleOrganic');
    if (result != null) {
...
class AddRecycleOrganicScreen extends StatefulWidget {
  @override
  _AddRecycleOrganicScreenState createState() {
    return _AddRecycleOrganicScreenState();
  }
}

class _AddRecycleOrganicScreenState extends State<AddRecycleOrganicScreen> {
  ...
  void _sendDataBack(BuildContext context) {
    ...
    var writtenProposal = Recycle('Organic Material', recycleDescription,
