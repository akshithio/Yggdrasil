...
class RecycleMetalsListScreen extends StatefulWidget {
  @override
  _RecycleMetalsListScreenState createState() {
    return _RecycleMetalsListScreenState();
  }
}

class _RecycleMetalsListScreenState extends State<RecycleMetalsListScreen> {
  void _awaitReturnValueFromInputScreen(BuildContext context) async {
    final result = await Navigator.pushNamed(context, '/AddRecycleMetals');
    if (result != null) {
    ...
    return Scaffold(
       ...
       body: FutureBuilder(
            future: Firestore.instance
                .collection('recycles')
                .where('category', isEqualTo: 'Metals')
                .getDocuments(),
...
class AddRecycleMetalsScreen extends StatefulWidget {
  @override
  _AddRecycleMetalsScreenState createState() {
    return _AddRecycleMetalsScreenState();
  }
}

class _AddRecycleMetalsScreenState extends State<AddRecycleMetalsScreen> {
  ...
  void _sendDataBack(BuildContext context) {
    ...
    var writtenProposal = Recycle(
        'Metals', recycleDescription, recycleQuantity, recycleSubCategory);
